...
class Settings(BaseSettings):
    ...
    REFERRAL_THRESHOLD: float = 0.5    # Cancer probability above this triggers referral
    UNCERTAINTY_THRESHOLD: float = 0.5  # Entropy above this = high uncertainty
    MC_DROPOUT_PASSES: int = 15         # MC Dropout forward passes (balanced speed/accuracy)
